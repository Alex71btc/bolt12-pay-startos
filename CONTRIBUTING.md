...
- **[`README.md`](./README.md)** — what this package is and how it's built (image, volumes, interfaces, dependencies). Technical reference for developers and AI assistants.
...
See [Environment Setup](https://docs.start9.com/packaging/environment-setup.html). You also need Docker with Buildx, since the service image is built locally from the [`Dockerfile`](./Dockerfile).
